...
//                     </label>
//                     <input type="text" defaultValue={updateData?.poster} placeholder="Movie poster" name="poster" className="input input-bordered" required />
//                 </div>
//                 <div className="form-control">
//                     <label className="label">
//                         <span className="label-text">Movie Title</span>
//                     </label>
//                     <input type="text"  defaultValue={updateData?.title} placeholder="Title" name="title" className="input input-bordered" required />
//                 </div>
//                 <div className="form-control">
//                     <label className="label">
//                         <span className="label-text">Movie Genre</span>
//                     </label>
//                     <select name="genre" className="input input-bordered"  defaultValue={updateData?.genre} required>
...
//                     </label>
//                     <input type="number" placeholder="Duration"  defaultValue={updateData?.duration} name="duration" className="input input-bordered" required />
//                 </div>
//                 <div className="form-control">
//                     <label className="label">
//                         <span className="label-text">Release Year</span>
//                     </label>
//                     <select name="release"  defaultValue={updateData?.release} className="input input-bordered" required>
...
//                     </label>
//                     <textarea placeholder="Summary"  defaultValue={updateData?.summary} name="summary" className="input input-bordered" required />
//                 </div>
    ...
    return (
        <div className="mx-auto my-10 p-10 bg-base-200">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button className="btn my-4 btn-warning w-full" type="submit">
                    Update Movie
                </button>
            </form>
        </div>
